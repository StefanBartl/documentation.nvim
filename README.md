...
[`docs/install.json`](docs/install.json) — here just `lua-language-server`,
...
| [docs/hover.md](docs/hover.md) | The hover.nvim integration: what the float says about the module under the cursor, and how it reports a map that has gone stale. |
