...
| [docs/ECOSYSTEM.md](docs/ECOSYSTEM.md) | **Architectural concept**, nothing implemented: where docs cross-references, API-endpoint inventory, hover previews and an API request runner each belong — and whether the runtime half (telemetry + request runner) is worth its own plugin beside this one. |
