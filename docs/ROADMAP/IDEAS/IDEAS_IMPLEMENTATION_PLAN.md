...
| ~~**2.2**~~ | S–M, medium–high, candidate | **built 2026-08-20** — S/high as re-rated | Same reason from the other side: the panel's input is a field every backend fills, not a heuristic this panel would have to invent |
