...
|---|---|---|
| `:DocMap` | `[all\|annotate\|bindings\|check\|checklist\|churn\|consumers\|diff\|dot\|endpoints\|full\|graph\|helptags\|impact\|mermaid\|open\|pick\|plugins\|serve\|tools\|untested\|why]` | Generate or verify the module map. The bare form writes artifacts. |
