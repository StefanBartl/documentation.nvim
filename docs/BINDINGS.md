...
|---|---|---|
| `:DocMap` | `[all\|annotate\|bindings\|check\|checklist\|churn\|consumers\|diff\|dot\|endpoints\|full\|graph\|helptags\|impact\|mermaid\|open\|plugins\|serve\|tools\|why]` | Generate or verify the module map. The bare form writes artifacts. |
