...
filter exactly — [`IDEAS.md`](../ROADMAP/IDEAS.md)'s own words: *"this
...
(nine exist today, see [`IDEAS.md` §2](../ROADMAP/IDEAS.md#2-new-analysis-panels))
...
- **Multi-repo scope.** `RULES/` spans 33 repos; documentation.nvim scans
  ...
  [`IDEAS.md` §6.6/§6.7](../ROADMAP/IDEAS.md#66-a-generic-cli-entry-no-per-repo-copy)
