...
---   local opts = require("documentation.config")(root)
---   vim.cmd("cq " .. require("documentation.cli").run(opts, _G.arg or {}))
---
...
function M.run(opts, argv)
  ...
  local tested, tested_total = require("documentation.coverage").summary(ir)
  ...
  local documented, doc_total = require("documentation.doccoverage").summary(ir)
  if doc_total > 0 then
    io.stdout:write(
