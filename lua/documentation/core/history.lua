---@module 'documentation.core.history'
...
---@return Documentation.History.FileDiff[]
...
---@return { fn: Documentation.FunctionInfo, first: integer, last: number }[]
...
---@param ir Documentation.IR|nil
---@param by_source table<string, string>|nil
---@param path string|nil
---@param ranges { first: integer, last: integer }[]
---@param acc table<string, Documentation.History.Touched>
...
---@param node string
---@param fn string
---@return Documentation.History.Caller[]
...
---@param ir_after Documentation.IR|nil
---@param ir_before Documentation.IR|nil
...
function M.analyze(diff_text, ir_after, ir_before)
  ...
  -- `:DocBrowse gI` and `diff.lua` use, so all three agree by construction.
  local reachable = {}
  if ir_after then
