---@module 'documentation.core.render.dot'
...
--- like. `:DocMap dot` opens it in a scratch buffer; what happens next is the
--- user's business.
...
function M.render(ir, opts)
  ...
  local out = {
    ("// %s graph of %s — generated by documentation"):format(kind, ir.meta.title or "the map"),
    "digraph docmap {",
