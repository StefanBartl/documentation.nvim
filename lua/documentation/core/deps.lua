---@module 'documentation.core.deps'
...
---@param src string
---@param requires Documentation.RawRequire[] Mutated in place.
...
---@param to_id string
---@return Documentation.Edge[]|nil chain Empty when `from_id == to_id`, nil when unreachable.
