---@module 'documentation.core.diff'
...
---Compare two maps.
---@param before Documentation.IR
---@param after Documentation.IR
---@return Documentation.Diff
function M.compare(before, after)
  local was, now = node_set(before), node_set(after)

  ---@type Documentation.Diff
  local diff = {
    nodes_added = {},
    nodes_removed = {},
    functions_added = {},
