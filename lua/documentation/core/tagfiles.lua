---@module 'documentation.core.tagfiles'
...
---way `Documentation.LayerRule` is: `lib.nvim` matches `lib.nvim.fs` but never
---`lib.nvimx`.
---@param mod string
...
---
---Reuses `core.find.node`'s resolution order (declared `@module`, raw
...
---function existed to close for `:DocMap graph`/`why`.
